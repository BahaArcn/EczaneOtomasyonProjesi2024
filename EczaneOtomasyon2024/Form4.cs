...
namespace EczaneOtomasyon2024
{
    public partial class Form4 : Form
    {
        ...
        private void Form4_Load(object sender, EventArgs e)
        {
            ...
            dataGridView1.Rows.Add("3", "12460295", "Korse", "20");
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                {
                    toplam += Convert.ToInt32(row.Cells["Fiyat1"].Value);
                }
        ...
        private void ecz_btn_girisYap_Click(object sender, EventArgs e)
        {
            ...
            {
                baglanti1.Open();
                SqlCommand eczaciKontrol = new SqlCommand("up_KullaniciKontrol1", baglanti1);
