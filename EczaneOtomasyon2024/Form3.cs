...
namespace EczaneOtomasyon2024
{
    public partial class Form3 : Form
    {
        ...
        object sonuc;     //Değişken atamaları
        string adi;
        ...
        private void GeciciIlacRefresh() //İlaçları geçici olarak tutan tabloyu yenile
        {
            string query = @"
            SELECT 
        ...
        private void Form3_Load(object sender, EventArgs e)  
        {
            ...
            dr_tabC.ItemSize = new Size(0, 1);                     //TabControlü sakla
            ...
            ekleButton.HeaderText = "İlaç Ekle";          //İlaçlar tablosunda ekle butonu oluştur
        ...
        private void dr_dgw_hastalar_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                SqlCommand komut = new SqlCommand("DELETE FROM GeciciIlac", baglanti1);   //Yeni hasta seçildiğinde geçici ilaç tablosunu temizle

                //Seçilen hastanın bilgilerini al ve yaşını hesaplayan fonksiyonu çağır
                ...
                SqlCommand yasKontrol = new SqlCommand("SELECT dbo.YasHesapla(@gun) AS Yas", baglanti1);  //hastanın yaşını hesaplayan fonksiyon çağrısı
        ...
        private void dr_dgw_ilaclar_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                baglanti1.Open();
                if ((int)sonuc >= Convert.ToInt16(dr_dgw_ilaclar.Rows[e.RowIndex].Cells["KullanimYasi"].Value)) //Kullanım yaşı kontrolü
                {            
                    if(e.ColumnIndex == dr_dgw_ilaclar.Columns["Ekle"].Index && e.RowIndex >= 0)
                    {
                        ...
                        SqlCommand komut = new SqlCommand("INSERT INTO GeciciIlac (IlacID) VALUES (@IlacID)", baglanti1); //Tıklanan ilacı geçici tabloya ekle
        ...
        private void dr_btn_profilGiris_Click(object sender, EventArgs e)
        {
            ...
            {
                baglanti1.Open();
                SqlCommand DoktorKontrol = new SqlCommand("up_KullaniciKontrol1", baglanti1);  //Giriş bilgilerini kontrol et
                ...
                if (kontrol == 1)
                {
                    ...
                    dr_tabC.ItemSize = new Size(80, 20);   // Varsayılan sekme boyutlarına geri dön
        ...
        private void dr_dgw_yazılanIlac_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                SqlCommand komut = new SqlCommand("DELETE FROM GeciciIlac WHERE IlacID=@Id", baglanti1); //Geçici ilaç tablosundan ilaç sil
        ...
        private void dr_btn_receteYazdır_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand ReceteEkle = new SqlCommand("sp_ReceteEkle", baglanti1); //Reçete ekleme stored procedure çağrısı
                ReceteEkle.CommandType = CommandType.StoredProcedure;

                // Giriş parametreleri
                ReceteEkle.Parameters.AddWithValue("@KullaniciAdi", dr_txt_usrName.Text); 
                ReceteEkle.Parameters.AddWithValue("@HastaTC", tcDegeri.ToString()); 
                ...
                {
                    if (Convert.ToInt16(dr_dgw_yazılanIlac.Rows[i].Cells["GeciciIlacID"].Value) == 0) { continue; } //Boş satırı atla
                    SqlCommand ReceteIlacEkle = new SqlCommand("INSERT INTO ReceteIcerik VALUES(@ReceteID,@IlacID)", baglanti1); //Reçeteyi oluştur ve içeriklerini içerik tablosuna ekle
        ...
        private void dr_btn_ilaçAra_Click(object sender, EventArgs e)
        {
            ...
            {
                baglanti1.Open();
                SqlCommand IlacAra = new SqlCommand("SELECT * FROM Ilaclar WHERE UrunAdi LIKE @deger2", baglanti1); //Adıyla ilaç arama
        ...
        private void dr_btn_hastaAra_Click(object sender, EventArgs e)
        {
            ...
            {
                baglanti1.Open();
                SqlCommand hastaAra = new SqlCommand("SELECT * FROM Hastalar WHERE TC LIKE @deger2", baglanti1); //TC ile hasta arama
        ...
        private void dr_btn_receteSorgu_Click(object sender, EventArgs e)
        {
            ...
            {
                baglanti1.Open();
                SqlCommand ReceteSorgu2 = new SqlCommand("sp_ReceteBul", baglanti1);   //Reçete sorgulama stored procedure çağrısı
                ...
                SqlParameter receteSahibiParam = new SqlParameter("@receteSahibi", SqlDbType.NVarChar, 50);  //Reçete sahibinin adını ve TC'sini döndüren çıkış parametreleri
